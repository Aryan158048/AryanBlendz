...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      'border border-white/10 bg-charcoal-900 px-3 py-2',
  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        ...
        'rounded-xl border border-white/10 bg-charcoal-800 shadow-[var(--shadow-dark-lg)]',
        'text-white',
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn(
      'py-1.5 pl-8 pr-2 text-xs font-semibold text-white/40 uppercase tracking-wider',
      className,
    )}
    {...props}
  />
