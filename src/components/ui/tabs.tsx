...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ...
    className={cn(
      ...
      'bg-charcoal-900 border border-white/8',
      'p-1 gap-1',
      className,
    )}
    {...props}
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      'hover:text-white/80',
      'data-[state=active]:bg-charcoal-700 data-[state=active]:text-white data-[state=active]:shadow-sm',
      'data-[state=active]:border-b-2 data-[state=active]:border-gold-500',
      className,
    )}
    {...props}
  />
